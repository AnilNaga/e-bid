...
//                 size="lg"
//                 onClick={openVerificationModal}
//                 className="bg-green-500 hover:bg-blue-600 animate__animated animate__pulse"
//               >
//                 Verify Documents
//               </Button>
//             </div>
...
const HomePage: React.FC = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-600 to-cyan-100 text-gray-800 overflow-hidden animate__animated animate__zoomIn">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="flex flex-col items-center animate__animated animate__slideInLeft">
              <h1 className="text-4xl font-bold text-gray-800 mb-4 drop-shadow-[0_4px_12px_rgba(6,182,212,0.6)]">
                META E AUCTION
              </h1>
              <div className="relative w-full max-w-md h-[350px] rounded-2xl overflow-hidden">
                <img
            ...
            <div className="flex flex-col gap-4 animate__animated animate__slideInRight">
              {isLoadingCurrent ? (
                <div className="flex justify-center items-center bg-blue-600/90 backdrop-blur-sm rounded-xl p-6 animate__animated animate__pulse">
                  <Package className="h-7 w-7 text-cyan-300 animate-spin" />
                </div>
              ) : currentauctions.length > 0 ? (
                <div className="flex flex-col overflow-hidden bg-blue-600/90 backdrop-blur-sm rounded-xl max-h-[300px] shadow-lg transition-all duration-500 hover:scale-105">
                  <div className="p-4 border-b border-blue-400 bg-gradient-to-r from-blue-500 to-cyan-400 z-10">
                    <h2 className="text-xl font-bold flex items-center text-white">
                      <TrendingUp className="h-5 w-5 mr-2" />
                      Current Auctions
                    </h2>
                  </div>
                  <div className="overflow-y-auto px-4 py-2 scrollbar-thin scrollbar-thumb-cyan-300 scrollbar-track-blue-600 hover:scrollbar-thumb-cyan-400">
                    {currentauctions.map((auction, index) => (
                      <Link
                        key={auction.id}
                        to={`/auction/${auction.id}`}
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div>
                            <h3 className="text-lg font-medium text-white mb-1">{auction.name}</h3>
                            <p className="text-base text-gray-100">{auction.description}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-lg font-bold text-cyan-300">
                              {formatCurrency(auction.startingPrice)}
              ...
              {!isLoadingCurrent && !isLoadingUpcoming && currentauctions.length === 0 && newauction.length === 0 && (
                <div className="bg-cyan-100/20 backdrop-blur-sm rounded-xl p-6 text-center text-cyan-200 animate__animated animate__pulse">
                  No current or upcoming auctions available.
                </div>
              )}
            </div>
      ...
      {/* Categories Section */}
      <section className="py-12 bg-blue-100 animate__animated animate__fadeInUp">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-8">Browse By Category</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <Link
                key={category.id}
                to={`/auctions?category=${category.id}`}
                className="bg-blue-600/90 backdrop-blur-sm hover:bg-blue-700/90 p-4 rounded-lg text-center transition-colors duration-300 border border-blue-400 animate__animated animate__zoomIn"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="bg-gradient-to-r from-blue-500 to-cyan-400 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                  {category.icon === 'tool' && <Award className="h-6 w-6" />}
                  {category.icon === 'flask' && <TrendingUp className="h-6 w-6" />}
                  {category.icon === 'cpu' && <DollarSign className="h-6 w-6" />}
                  {category.icon === 'car' && <Award className="h-6 w-6" />}
                ...
                <p className="text-sm text-gray-100 mt-1">{category.description}</p>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={partner.name}
                className="bg-blue-600/90 backdrop-blur-sm p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow border border-blue-400 animate__animated animate__fadeInUp"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="h-20 flex items-center justify-center mb-4">
                  <img
                ...
                <p className="text-sm text-gray-100 text-center">{partner.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 bg-blue-100 animate__animated animate__fadeInUp">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-blue-600/90 backdrop-blur-sm rounded-lg shadow-md p-6 max-w-3xl mx-auto border border-blue-400 animate__animated animate__fadeIn">
            <h3 className="text-xl font-semibold mb-4 text-center text-white">Our Commitment</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Secure escrow payments for safe transactions",
                "Verified sellers and quality materials",
                ...
                >
                  ...
                  <p className="text-gray-100">{commitment}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* CTA Section */}
      {userData?.status !== "verified" && (
        <section className="py-16 bg-blue-100 text-gray-800 animate__animated animate__pulse">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Get Started?</h2>
            <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses buying and selling scrap materials on Meta E Bid.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                size="lg"
                onClick={openVerificationModal}
                className="bg-gradient-to-r from-blue-500 to-cyan-400 hover:bg-gradient-to-r hover:from-blue-600 hover:to-cyan-500 animate__animated animate__pulse"
              >
                Verify Documents
              </Button>
            </div>
      ...
      {/* FAQ Section */}
      <section className="py-16 bg-blue-100 animate__animated animate__fadeInUp">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-16">Frequently Asked Questions</h2>
          <div className="max-w-3xl mx-auto space-y-6">
            {faqItems.map((faq, index) => (
              <div
                key={index}
                className="bg-blue-600/90 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-blue-400 transition-all duration-200 hover:shadow-xl animate__animated animate__fadeIn"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <button
                  onClick={() => setOpenFaqIndex(openFaqIndex === index ? null : index)}
                  className="w-full px-6 py-5 text-left flex justify-between items-center hover:bg-blue-700/90 transition-colors"
                >
                  <h3 className="text-lg font-semibold text-white flex items-center">
                    <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 text-white mr-3">
                      {index + 1}
                    </span>
                    {faq.question}
                  </h3>
                  {openFaqIndex === index ? (
                    <ChevronUp className="h-5 w-5 text-cyan-300 flex-shrink-0 ml-4" />
                  ) : (
                    <ChevronDown className="h-5 w-5 text-cyan-300 flex-shrink-0 ml-4" />
                  )}
                </button>
                <div
                  className={`transition-all duration-300 ease-in-out ${
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                {[
                  { icon: <Mail className="h-6 w-6 text-cyan-300 mt-1" />, title: "Email", content: "info@metaebid.com" },
                  { icon: <Phone className="h-6 w-6 text-cyan-300 mt-1" />, title: "Phone", content: "+1 (555) 123-4567" },
                  {
                    icon: <MapPin className="h-6 w-6 text-cyan-300 mt-1" />,
                    title: "Address",
                    content: "123 Industrial Park, Suite 456<br />New York, NY 10001"
                  }
                ].map((contact, index) => (
              ...
              <form className="space-y-4 animate__animated animate__fadeInRight">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="mt-1 block w-full rounded-md border-blue-400 shadow-sm focus:border-cyan-400 focus:ring-cyan-400 bg-blue-500/80 backdrop-blur-sm text-white placeholder-gray-300"
                  />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email</label>
                ...
                <Button
                  type="submit"
                  variant="primary"
                  className="w-full bg-gradient-to-r from-blue-500 to-cyan-400 hover:bg-gradient-to-r hover:from-blue-600 hover:to-cyan-500 animate__animated animate__pulse"
                >
                  Send Message
                </Button>
              </form>
